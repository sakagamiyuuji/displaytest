...
class YourChoiceAdapter() : BaseBindingAdapter<BaseBindingViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BaseBindingViewHolder {
        return BaseBindingViewHolder(
            AdapterSliderHorizontalContentBinding.inflate(
    ...
    override fun updateBinding(holder: BaseBindingViewHolder, binding: ViewBinding, position: Int) {
        val bind = binding as AdapterSliderHorizontalContentBinding
